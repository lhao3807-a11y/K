...
SEED_DYNASTY = dict(
    ...
    peak_year=1081, seed=9601279, is_active=1,
...
SEED_EVENTS = [  # (year, title, term, dir, mag, desc)
    ...
    (1082, "永乐城之败 · 神宗痛哭", "见顶回落", "bear", "-大",
     "大举攻西夏永乐城惨败，士卒伤亡数十万，神宗临朝痛哭，变法成果受挫。国运指数于上年见顶，本年破位，由盛转衰。"),
...
SEED_ANCHORS = [
    (960, 100), (978, 124), (979, 140), (980, 112), (1000, 124), (1003, 112),
    (1004, 138), (1005, 126), (1022, 146), (1043, 178), (1069, 186),
    (1082, 222), (1085, 204), (1100, 168), (1101, 164), (1102, 158),
    (1124, 150), (1126, 140), (1127, 70), (1130, 90), (1139, 108),
    (1140, 121), (1142, 96), (1165, 150), (1186, 158), (1187, 168),
    (1207, 128), (1234, 112), (1258, 116), (1259, 121), (1272, 100),
...
REGISTRY = [
    ...
    ("DAQIN.221", "大秦王朝", -221, -207, 22100207,
     "前221年秦灭六国挂牌，前207年刘邦入关摘牌；短命高波动标的"),
    ("DAHAN.202", "大汉王朝", -202,  220, 20200220,
